...
#7 WE$=CHR$(169)+CHR$(112)+CHR$(128)+CHR$(64)+CHR$(214)+CHR$(234)+CHR$(96)
#8 FORI=1TOLEN(WE$):POKE678+I,ASC(MID$(WE$,I,1)):NEXT
#9 SYS 679
...
1000 POKE55042,0: REM SET DMA LIST BANK 0
1010 POKE55041,192: REM SET DMA LIST HIGH-BYTE
1015 POKE55040,DL*12: REM SET DMA LIST LOW-BYTE, AND EXECUTE
1020 RETURN
