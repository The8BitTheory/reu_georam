...
3 MP=57088:GB=57343:GP=57342:LA=1:BR=1024:B2=1024:CP=55296:C2=CP-32768:BN=4
...
340 GOSUB 440:PRINT ""TI-S:GOTO 310
350 END
...
# COUNT LSB, MSB ($3E8 = 1000)
802 DL$=DL$+CHR$(FNLB(AN))+CHR$(FNHB(AN))

# SOURCE ADDRESS LSB,MSB
803 DL$=DL$+CHR$(FN LB(C2))+CHR$(FN HB(C2) OR 128)

# SOURCE ADDRESS BANK AND FLAGS (16 BANKS WITH 64KB EACH AVAILABLE)
804 DL$=DL$+CHR$(0)

# DEST ADDRESS LSB,MSB
805 DL$=DL$+CHR$(FNLB(AN))+CHR$(FNHB(AN))
...
# COUNT LSB, MSB ($3E8 = 1000)
852 DL$=DL$+CHR$(FNLB(AN))+CHR$(FNHB(AN))

# SOURCE ADDRESS LSB,MSB (ZERO AT BANK 4)
853 DL$=DL$+CHR$(FNLB(AN))+CHR$(FNHB(AN))

# SOURCE ADDRESS BANK AND FLAGS (16 BANKS WITH 64KB EACH AVAILABLE)
854 DL$=DL$+CHR$(BN)

# DEST ADDRESS LSB,MSB
855 DL$=DL$+CHR$(FN LB(C2))+CHR$(FN HB(C2) OR 128)
...
1005 S=TI:POKE55042,0: REM DMA LIST IS IN BANK 0
