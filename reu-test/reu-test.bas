...
5 AN=1000:AL=FNLB(AN):AH=FNHB(AN)
6 SL=FNLB(B2):SH=FNHB(B2)
7 CL=FNLB(C2):CH=FNHB(C2) OR 128
...
# REU STASH SCREEN
280 POKEMP+2,SL:POKEMP+3,SH
282 POKEMP+4,0:POKEMP+5,0
284 POKEMP+6,0
286 POKEMP+7,AL:POKEMP+8,AH
288 POKEMP+1,144

# REU STASH COLOR
290 POKEMP+2,CL:POKEMP+3,CH
292 POKEMP+4,FN LB(AN+1):POKEMP+5,FN HB(AN+1)
294 POKEMP+6,0
296 POKEMP+7,AL:POKEMP+8,AH
298 POKEMP+1,144
...
# REU FETCH COLOR
440 POKEMP+2,CL:POKEMP+3,CH
450 POKEMP+4,FN LB(AN+1):POKEMP+5,FN HB(AN+1)
460 POKEMP+6,0
470 POKEMP+7,AL:POKEMP+8,AH
480 POKEMP+1,145

# REU FETCH SCREEN
490 POKEMP+2,SL:POKEMP+3,SH
500 POKEMP+4,0:POKEMP+5,0
510 POKEMP+6,0
520 POKEMP+7,AL:POKEMP+8,AH
530 POKEMP+1,145
