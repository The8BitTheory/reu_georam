...
350 POKE 2,$23:POKE 3,$9F

355 REM SET MEMORY-COPY DESTINATION ($4,$5) ADDRESS TO DATA-PORT 1 ($9F24)
360 POKE 4,$24:POKE 5,$9F

365 REM SET MEMORY-COPY NR OF BYTES ($6,$7) TO 8192 BYTES ($2000)
370 POKE 6,$00:POKE 7,$20
...
460 POKE 2,$24:POKE 3,$9F

465 REM SET MEMORY-COPY DESTINATION ($4,$5) ADDRESS TO DATA-PORT 0 ($9F23)
470 POKE 4,$23:POKE 5,$9F

475 REM SET MEMORY-COPY NR OF BYTES ($6,$7) TO 8192 BYTES ($2000)
480 POKE 6,$00:POKE 7,$20
...
530 POKE $9F20,0:POKE $9F21,$B0:POKE $9F22,$11

540 REM DATA-PORT 1
550 POKE $9F25,1
560 REM SET VRAM-ADDRESS TO $1.D000
570 POKE $9F20,0:POKE $9F21,$D0:POKE $9F22,$11
