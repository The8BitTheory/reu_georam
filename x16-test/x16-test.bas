...
345 REM SET MEMORY-COPY NR OF BYTES ($6,$7) TO 8192 BYTES ($2000)
350 POKE 6,$00:POKE 7,$20
...
445 REM SET MEMORY-COPY NR OF BYTES ($6,$7) TO 8192 BYTES ($2000)
450 POKE 6,$00:POKE 7,$20
